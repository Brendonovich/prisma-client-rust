...
pub fn create_fn(comp_type: &dml::CompositeType, module_path: &TokenStream) -> Option<TokenStream> {
    comp_type
        .fields
        .iter()
...
pub fn enum_definition(comp_type: &dml::CompositeType, module_path: &TokenStream) -> TokenStream {
