...
See <a href="https://github.com/Brendonovich/prisma-client-rust/blob/0.6.0/src/raw.rs#L119-L139" target="_blank">this enum</a> for a reference of how database types map to Rust types.
