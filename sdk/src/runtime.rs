...
pub struct GeneratorMetadata {
    generate_fn: fn(GenerateArgs) -> String,
    name: &'static str,
...
pub fn run_generator(args: &Vec<String>, generator: GeneratorMetadata) {
    if args.len() > 0 {
    ...
    loop {
        ...
        let value = match input.method.as_str() {
            ...
            "generate" => {
                ...
                let dmmf: EngineDMMF = serde_path_to_error::deserialize(deserializer)
...
fn generate(generator: &GeneratorMetadata, dmmf: EngineDMMF) {
    ...
    let args = GenerateArgs::new(datamodel, schema, dmmf);

    validate_names(&args);

    let generated_str = (generator.generate_fn)(args);
